...
var Character = function (_React$Component) {
    ...
    _createClass(Character, [{
        ...
        value: function componentDidUpdate(prevProps) {
            if (prevProps.params.id != this.props.params.id) _CharacterActions2.default.getCharacter(this.props.params.id);
        }
    }, {
        key: 'onChange',
        value: function onChange(state) {
...
var CharacterList = function (_React$Component) {
    ...
    _createClass(CharacterList, [{
        ...
        key: 'componentDidUpdate',
        value: function componentDidUpdate(prevoProps) {
            if (!(0, _underscore.isEqual)(prevProps.params, this.props.params)) _CharacterListActions2.default.getCharacters(this.props.params);
        }
    }, {
        key: 'onChange',
        value: function onChange(state) {
...
var AddCharacterStore = function () {
    ...
    _createClass(AddCharacterStore, [{
        ...
        value: function onAddCharacterFail(jqXhr) {
        ...
        key: 'onUpdateGender',
        value: function onUpdateGender(e) {
